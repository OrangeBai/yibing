...
RW00_SEC_LENT = [
    "RCFDS517",
    "RCONS517",
]  # RC-R, Part 2, 16. The original code incorporates the securities lent (RCONB665), while this is removed after 2014 and included in code RCONS517.
REPO_SEC = [
    "RCFDB995",
    "RCONB995",
]  # RC, Liabilities, 14.b. Federal funds purchased and securities purchased under agreements to resell, Securities sold under agreements to repurchase Same field from FFIEC 034, RCON0279, ignored here.
...
REPO_FFUND = [
    "RCONB989",
    "RCFDB989",
]  # RC, Assets, 3.b. Federal funds sold and securities purchased under agreements to resell,  securities purchased under agreements to resell.
RW50_SEC_LENT = [
    "RCONS521",
    "RCFDS521",
]  # RC-R, 16. Repo-style transactions 50% risk weight category. # Notice that here we are missing RCONB667.
...
FED_HOME_LOAN_BANK_ADVANCE = [
    "RCFDF055",
    "RCONF055",
    "RCFD2651",
    "RCON2651",
]  # RC-M, Federal Home Loan Bank advances, one year or less
...
DERI_INT_RATE_FAIR_VALUE_NEG_HOLD_FOR_TRADING = [
    "RCON8737",
    "RCFD8737",
]  # RC-L 15.a.(1)
DERI_FOR_EXCH_FAIR_VALUE_NEG_HOLD_FOR_TRADING = [
    "RCON8738",
    "RCFD8738",
]  # RC-L 15.a.(1)
DERI_EQU_DERI_FAIR_VALUE_NEG_HOLD_FOR_TRADING = [
    "RCON8739",
    "RCFD8739",
]  # RC-L 15.a.(1)
DERI_COM_OTHE_FAIR_VALUE_NEG_HOLD_FOR_TRADING = [
    "RCON8740",
    "RCFD8740",
]  # RC-L 15.a.(1)

DERI_INT_RATE_FAIR_VALUE_NEG_HOLD_NOT_TRADING = [
    "RCON8745",
    "RCFD8745",
]  # RC-L 15.b.(1)
DERI_FOR_EXCH_FAIR_VALUE_NEG_HOLD_NOT_TRADING = [
    "RCON8746",
    "RCFD8746",
]  # RC-L 15.b.(1)
DERI_EQU_DERI_FAIR_VALUE_NEG_HOLD_NOT_TRADING = [
    "RCON8747",
    "RCFD8747",
]  # RC-L 15.b.(1)
DERI_COM_OTHE_FAIR_VALUE_NEG_HOLD_NOT_TRADING = [
    "RCON8748",
    "RCFD8748",
]  # RC-L 15.b.(1)
