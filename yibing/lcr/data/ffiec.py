...
FRY9C_DOWNLOAD_PREFIX = (
    "http://www.ffiec.gov/npw/FinancialReport/ReturnBHCFZipFiles/?zipfilename="
)
...
FRY9C_QUARTER_MAP = {1: "0331", 2: "0630", 3: "0930", 4: "1231"}
HEADER = {
...
def _download_fry_9c(year, quarter):
    ...
    response = requests.get(
        FRY9C_DOWNLOAD_PREFIX + file_name, stream=True, headers=HEADER
    )  # Stream the response
